...
function downloadReport() {
  ...
  const handleFileInputClick = async (e) => {
    ...
    try {
      ...
      const data = await response.json();
      // Inform user if this is their first X-ray, but still allow upload
              ...
              <div style={{
                ...
                <div>
                  ...
                  <p style={{ color: '#78350f', fontSize: '0.875rem', lineHeight: 1.6 }}>
                    No prior X-ray found. This will be your <strong>baseline</strong> record. Future uploads will be compared against it for progress tracking.
                  </p>
                </div>
              </div>
            )}
