  ...
  return (
    <div className="patient-layout">
      ...
      <nav className="layout-top-nav">
        ...
        {/* ── Horizontal nav links in centre ── */}
        <div className="nav-links-centre">
          <Link to="/patient-dashboard" className={`nav-link-item${isActive('/patient-dashboard') ? ' active' : ''}`}>
          ...
          <Link to="/patient-profile" className={`nav-link-item${isActive('/patient-profile') ? ' active' : ''}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Link to="/progress-detection" className={`nav-link-item${isActive('/progress-detection') ? ' active' : ''}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>
            </svg>
            Track Progress
          </Link>
          <Link to="/doctor-recommendation" className={`nav-link-item${isActive('/doctor-recommendation') ? ' active' : ''}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            Doctos prescreptions
            {newPrescriptionsCount > 0 && <span className="prescription-notification-dot"/>}
          </Link>
          <Link to="/dr-avatar" className={`nav-link-item${isActive('/dr-avatar') ? ' active' : ''}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="nav-right">
          <button className="notification-bell-nav" onClick={() => setShowNotifications(!showNotifications)}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
